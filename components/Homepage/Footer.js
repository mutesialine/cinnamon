  ...
  return (
    <div className="max-w-full  bg-fullblack bg-[url(/image/noise.png)] text-white  ">
      <div className="  max-w-6xl mx-auto px-6 pt-[90px] pb-[50px]  flex flex-col justify-between ">
        ...
        <div className="flex flex-col-reverse lg:flex-row    lg:justify-between lg:pt-8  lg:pb-8">
          ...
          <div className="flex justify-between lg:justify-start px-14 lg:px-0 gap-6 py-6 lg:py-0 border-y border-y-[#8f8f8f66] border-solid lg:border-none">
            <img className="w-5" src="/icons/linkedln.svg" alt="linkedin" />
            <img className="w-5" src="/icons/cinnamonbe.svg" alt="behance" />
            <img className="w-5" src="/icons/instagram.svg" alt="instagram" />
            <img className="w-5" src="/icons/facebook.svg" alt="facebook" />
            <img className="w-5" src="/icons/cinnamonrss.svg" alt="rss" />
          </div>
        </div>
      </div>
    </div>
